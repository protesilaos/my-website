---
title: "Comment on a Marxist critique of Free Software"
excerpt: "My thoughts on a 15.000-word essay that criticises free software without showing an alternative."
---

I just read an article by Abhijit A.M. in _The Anvil_ journal. Its
title is _The Decline of the Copyleft Free Software Movement and Its
Ideological Limitations_. It is subtitled _A Marxist Critique of the
Free Software Movement_. It makes several interesting points about the
state of free software and the role of the open source movement.

The thrust of the critique is that (i) free software ideology is
...
In the ~15.000-word essay, the author makes references to colonialism,
...
But there is no such thing. The catch-22 with Marxism is that the
...
ultimately uninspiring remarks:

> For the FSM [Free Software Movement] to grow its strength and
...
>
> After this ebb, the true fillip to the FSM is possible now only with
...
What exactly should we be doing to carve this "revolutionary and
subversive character" out of what we have? Nothing! These are just
words.

What I make of the article is that the author has either not done
...
In my experience, the average Marxist intellectual is not agrarian
...
frailties of the bourgeois world and the virtues of working peoples.

Everyone can share their opinion on what Richard Stallman and friends
...
lots of people over the course of decades.

The best kind of criticism is an alternative implementation and/or a
...
A.M. has not demonstrated anything of the sort.

The free software movement does not fall into the aforementioned
...
changes to their individual and collective experience.

If I need to abolish capitalism to write an extension for GNU Emacs
...
Yes, this is freedom in principle because it assumes that someone has
...
If I have to put my faith in some wider working-class movement to make
...
The working class is a useful descriptor for some shared qualities.
...
interest or field of endeavour.

If I want to discuss poetry, for example, I can only do so in the
...
their vaunted alpha masculinity that it cannot tolerate a violin).

My suggestion to Abhijit A.M. and anyone who has ideas about the world
