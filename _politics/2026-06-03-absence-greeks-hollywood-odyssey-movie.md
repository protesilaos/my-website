---
title: "On the absence of Greeks from Hollywood's Odyssey movie"
excerpt: "I explain why the lack of Greek actors from a Hollywood production is not a problem, given what art is about."
---
...
> An honourable intention [to have a multicultural cast]. But for us
...
> authentically connected to the source?

Sure, it would be nice. Though I personally do not see any problem in
...
simply ignore it and move on with our lives.

The Greeks who care about expressing themselves---and their cultural
...
our stead. Their values are not our values.

That Helen of Troy is a black woman (Lupita Nyong’o), for example, is
...
Human expression relies on simplification, symbolism, and metaphor to
...
Athena, for example, is a proxy for wisdom. Our artistic genius
...
Part of what acculturation is about is to make people understand that
...
though must never be the focus of our attention and worship.

Those who only recognise the idol, which in this case are the actors
...
stereotypically Greek-looking artists take on the various roles.

My suggestion if you really care about the Odyssey is to read the
...
it will eventually harm you.

And to my fellow Greeks: if you are proud of your heritage, then do
