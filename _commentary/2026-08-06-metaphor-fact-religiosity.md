---
title: "Metaphor and fact in religiosity"
excerpt: "Extensive commentary on allegory and fact in the context of religion and beyond."
---

For years now I have adopted the view that religious narratives are
...
prescriptive statements is established.

## Memorable and teachable

Any narrative that contributes to such a framework has to have
...
This approach emphasises the role of the tutelary figure: the teacher,
...
the social whole they are addressing.

A myth, for example, is not an event that actually happened. It is not
...
applies to immediately recognisable phenomena.

## Facts and their constraints

Facts, then, are interesting details that can reinforce the effect of
...
sets or relevant resources: those are not mnemonic, for instance.

Facts may render stories specific to their context: if a story is tied
...
generalisation will have to be done beyond those specificities.

Data sets about such details are no mere supporting material though.
...
Imagine that if religion is factual, it too has to be consistent with
...
I am not aware of any religion that is purely factual of the sort here
...
and whether the goalposts will keep shifting if expedient.

## From facts to ideology

My claim that religion is fundamentally allegorical is not to discount
...
once each focuses on its strengths.

This approach also saves science from the trap of scientism, namely,
...
A defining feature of our era is said scientism. People try to find
...
the requisite scepticism.

It is common for those under the sway of scientism to rely on an
...
Scientism debases both science and culture because it stands at an
awkward intermediate state between the two, combining their parts in
the worst possible way.

I want to help people find focus in their life instead of getting
...
> The magician, in the tarot world, is represented as someone in robes
...
> these things in a table, in calmness.
>
> Tomberg is his Meditations on the Tarot, expounds about this topic
...
Should we take this literally? Are the four elements a statement of
...
precise measurement of the earth and wind present in my keyboard?

I think the four elements are metaphorical as a simplification of a
...
Same principle for Jesus as the ultimate magician. If this is a
...
is who they claim to be (e.g. son of God, the trinity, etc.).

If Jesus is the ultimate magician who is, ipso facto, superior to all
...
How would we, the lesser people, even have the acumen to correctly
...
These and many more are questions that naturally follow from the basic
notion that Jesus qua ultimate magician is a fact. We cannot hold back
those questions because then we are no longer rigorous with our claims.

If, however, we take this metaphorically we again have lots of
...
When we admit that we are reading resources in a spirit of openness to
...
statement or symbol at face value.

Furthermore, we adapt the lessons to the prevailing realities.
Interpretation becomes a tool that empowers us. We are not limited to
the scope that the facts delimit.

Continuing from the blog:

> I am a firm believer of the phenomenology of magick; as a christian
...
> with God amongst other tests.

Consider the story of Elijah here. If God literally rained fire on
...
questions, each with far-reaching implications.

Furthermore, if this is a literal event, then it raises questions
...
Is fire the best way to convince people?

Plus everything I mentioned above about validating the claimed facts.

I am not searching for answers here. I am pointing out what happens
once you commit to a literal reading of the stories.

If, however, we take it metaphorically then we have a useful story in
...
Same idea for St. Theresa levitating. What does that even mean in a
...
and are filling in the blanks with what we wish to see there.

If we say that this is all magic that we simply cannot comprehend,
...
## Symbols and practicality

From the blog:

> I consider that everything is real when it comes to this kind of
...
> nephilim, or son of the angels that left the sky.

What does "real" mean though? Metaphors are also real because they
...
representing the abstraction from the multitude of relevant patterns.

For example, Aesop's fable of the ant and the grasshopper pertains to
...
he made up; a story with mnemonic and didactic value.

If, however, we claim something like "Hera is real" and by that we
...
story of the ant and the grasshopper actually happened".

Hera is not a person. There is no lady in the sky waiting for us to do
...
through aeons of experimentation, such as:

- Children need a mother figure in their midst.
- Families benefit from having a just matriarch figure around (e.g.
  the grandmother in an extended family that everybody loves and
  listens to).
- The extended family distributes the workload, making it easier to
  raise children and take care of the elderly, while still handling
  everyday work.
- Societies are stable long-term when social reproduction
  (biological + cultural continuity) extends from the family, to the
  neighbourhood, and continues outward.
- Resilience long-term is about sustainable intergenerational relations.

We do not have to appeal to Hera to make those and related points. A
...
will likely remain relevant long-term.

At any rate, Hera is a symbol: a name or alias for a long list of
...
Names/aliases/symbols are part of our everyday affairs. Imagine if
...
usable if it cannot employ these mental shortcuts.

We rely on names/aliases/symbols to keep things focused. At some
...
thus had not created the relevant synapses in his brain.

Coming back to religion, metaphors empower us to keep things focused
...
to learn (again, mnemonic and didactic value).

Furthermore, saying that Hera is real, in the sense of a person or
...
whether that is constructive or not in light of social affairs.

## The significance of faith

From the blog:

> For the magi not only needs discipline and knowledge, but also trust
...
> fact that, as Borges said, there are more things.

Indeed, there are more things. Such as other people in present time
...
The defining feature of our era is that "more things" are subordinated
...
Faith in other things needs to be couched in terms of the
...
Faith in Hera as a given figure, however, or the nephilim, or whether
...
even define the best footballer ever? And, no, I am not joking.

None of this is limited to religion, by the way. It is how the curious
...
A sustainable option for the uncompromising thinker is to learn how to
...
the world of practicality and another in the world of thought.

Those granted, faith performs the vital function of keeping people
...
And here, too, the typical modern person errs because they conflate
...
cost, like in the cases of Socrates and Baruch Spinoza.

## An empty shirt

When we make a literal reading of symbols and names, we end up in a
...
into coercion, as it lacks the means of persuasion through reason.

The 20th century Greek poet Giorgos Seferis alludes to pointless
squabbles and campaigns in his poem [Ελένη (Helen)](https://www.greek-language.gr/digitalResources/literature/tools/concordance/browse.html?cnd_id=1&text_id=3175),
...
"Helen" here is a reference to Helen of Troy. She is the stated reason
...
other over unattainable trophies.

Helen is a myth, which remains ever-relevant. There is such a Helen
...
Ukrainians, and those in the European Union.

In the context of religiosity, Helen as the empty shirt is what we get
...
about all the atrocities they commit.

We do not get such phenomena in discussions that stick to the facts or
...
nevertheless have the potential to lead to actual harm.

The intellectual's responsibility is to stay focused on the essence,
avoid empty shirts, and communicate with others dispassionately so
that they also focus on what is the deeper issue.

## A matter of initiative

With those granted, we are left with how I originally concluded my
previous article about [the way of the wizard](https://protesilaos.com/commentary/2026-08-03-way-wizard/) (2026-08-03):

> Perhaps, then, the safest option is become a wizard yourself.

The wizard I have in mind is the philosopher (literally "friend of
...
The point here is not to demand personal accountability for systemic
...
If we see the world that envelops us erode before our eyes and if we
...
This is how I approach it for my immediate environment: I have no
...
how they self-destruct or destroy others.

Maybe those combined with my admittedly limited efforts to make
...
It is my style to not make promises or talk big: I do what I have
