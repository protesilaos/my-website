...
**UPDATE 2022-05-20 09:35 +0300.**  Changed the Greek word for "buffer"
from "αποσβεστήρας" to "ενταμιευτής".  Thanks to Basil L. Contovounesios
and Romanos Skiadas for the feedback in [Emacs
bug#55332](https://debbugs.gnu.org/cgi/bugreport.cgi?bug=55332).  For
future updates to the `TUTORIAL.el_GR` file, check the emacs.git source.

**UPDATE 2022-05-08 19:07 +0300.**  My contribution is now part of
Emacs.  See the Annex below for a verbatim copy of `TUTORIAL.el_GR`.
...
This is `TUTORIAL.el_GR` as of the latest update on 2022-05-20 09:38
+0300.
