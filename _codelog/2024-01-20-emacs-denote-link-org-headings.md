...
Denote to (i) link to Org headings while still using the `denote:`
link type, and (ii) extract a heading with its contents into a
standalone Denote note.

These features are part of the current development version.
